...
//     console.log(`Swapping ${fromAmount} ${fromCrypto} on ${fromChain} for ${toCrypto} on ${toChain}`)
//   }

//   const handleFromAmountChange = (value: string) => {
//     setFromAmount(value)
//     // Placeholder for price calculation logic
//     setToAmount((parseFloat(value) * 0.95).toFixed(6)) // Assuming 5% slippage for demo
//   }
